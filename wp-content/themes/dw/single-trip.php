...
<main class="layout single-trip">
    ...
    <aside class="single-trip__details">
        <h3 class="single-trip__subtitle">Détails du voyage</h3>
        <dl class="single-trip__definitions">
            <dt class="single-trip__label">Date de départ</dt>
            ...
            <dt class="single-trip__label">Date de retour</dt>
            ...
            <?php else: ?>
                <span class="date__empty">Il n'y a pas encore de date de retour de prévue pour le moment</span>
            <?php endif; ?>
            </dd>
        </dl>
    </aside>
